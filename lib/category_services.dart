...
class Rows {
  Future<List<Items>> takeFirstItems() async {
    ...
    var i2 = Items(itemId: 2, image: "assets/images/Contenterra.png", icon: "assets/icons/icon_C.png", title: "ContenTerra", type: "IT Services", star: 4.7, priceOrSize: "30MB");
    var i3 = Items(itemId: 3, image: "assets/images/linkedin.png", icon: "assets/icons/icon_in.png", title: "LinkedIn", type: "Social", star: 4.3, priceOrSize: "60MB");
  ...
  Future<List<Items>> takeSecondItems() async {
    ...
    var i2 = Items(itemId: 2, image: "assets/images/fm.png", icon: "assets/icons/icon_fm.png", title: "FM22 Mobile", type: "Sport | Strategy", star: 4.5, priceOrSize: "₹24.99");
    var i3 = Items(itemId: 3, image: "assets/images/magnus.png", icon: "assets/icons/icon_magnus.png", title: "Magnus Trainer", type: "Strategy | Simulation", star: 4.5, priceOrSize: "₹24.99");
